...
namespace API.Controllers
{
    ...
    public class EmployeesController : ControllerBase
    {
        ...
        public EmployeesController(DbContexts context, IWebHostEnvironment webHostEnviroment)
        {
            _context = context;
        ...
        public async Task<IActionResult> CreatProduct([FormBoby] Employees employee)
        {
    ...
    internal class FormBobyAttribute : Attribute
    {
    }
}